...
/*if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['code'])){
    ...
    $redirectUri = urlencode('url informada no app');
    
    $code = $_GET['code'];
    
    $token_url = "https://graph.facebook.com/oauth/access_token?" . "client_id=" . $appId . "&redirect_uri" . $redirectUri . "&client_secret" . 
        $appSecret . "&code" . $code;
...
<body class="hold-transition login-page">
	...
	<div class="login-box-body">
      ...
      <p>- OU -</p>
            ...
            <div class="fb-login-button" data-scope="public_profile,email" onlogin="
               checkLoginState();"></div>
    </div>
